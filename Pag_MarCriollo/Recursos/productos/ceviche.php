    ...
    <main>
        ...
        <div id="overlayContainer" class="overlay-container" style="display: none;">
            <div class="overlay">
                <div class="overlay-content">
                    ...
                    <script>
                    const modelPath = "../../Recursos/productos/assets/ceviche/ceviche.gltf";
                    const model = "";
                    </script>
                </div>
            </div>
        ...
        <div class="productoCarta">
            <div class="ruletaProducto"> <!-- Ruleta de imagenes de referencia -->
                ...
                <div class="contenedorImg" id="overlayButton"><img src="../../Recursos/productos/img/ceviche3D.png" alt="Imagen" loading="lazy" onclick="cambiarImagen(this)"></div>
